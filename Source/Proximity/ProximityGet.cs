...
namespace Proximity
{
    ...
    public class ProximityGet
    {
        ...
        public static float GetProxImmunityGainSpeedOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxImmunityGainSpeedOffSet).Value;
            }
        ...
        public static float GetProxNegotiationAbilityOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxNegotiationAbilityOffSet).Value;
            }
        ...
        public static float GetProxPsychicSensitivityOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxPsychicSensitivityOffSet).Value;
            }
        ...
        public static float GetProxSocialImpactOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxSocialImpactOffSet).Value;
            }
        ...
        public static float GetProxToxicSensitivityOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxToxicSensitivityOffSet).Value;
            }
        ...
        public static float GetProxComfyTemperatureMinOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxComfyTemperatureMinOffSet).Value;
            }
        ...
        public static float GetProxAimingDelayFactorOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxAimingDelayFactorOffSet).Value;
            }
        ...
        public static float GetProxMeleeDodgeChanceOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxMeleeDodgeChanceOffSet).Value;
            }
        ...
        public static float GetProxMeleeHitChanceOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxMeleeHitChanceOffSet).Value;
            }
        ...
        public static float GetProxMedicalTendSpeedOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxMedicalTendSpeedOffSet).Value;
            }
        ...
        public static float GetProxMedicalTendQualityOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxMedicalTendQualityOffSet).Value;
            }
        ...
        public static float GetProxMedicalOperationSpeedOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxMedicalOperationSpeedOffSet).Value;
            }
        ...
        public static float GetProxAnimalGatherSpeedOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxAnimalGatherSpeedOffSet).Value;
            }
        ...
        public static float GetProxAnimalGatherYieldOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxAnimalGatherYieldOffSet).Value;
            }
        ...
        public static float GetProxConstructionSpeedOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxConstructionSpeedOffSet).Value;
            }
        ...
        public static float GetProxConstructSuccessChanceOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxConstructSuccessChanceOffSet).Value;
            }
        ...
        public static float GetProxEatingSpeedOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxEatingSpeedOffSet).Value;
            }
        ...
        public static float GetProxHuntingStealthOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxHuntingStealthOffSet).Value;
            }
        ...
        public static float GetProxMiningSpeedOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxMiningSpeedOffSet).Value;
            }
        ...
        public static float GetProxPlantHarvestYieldOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxPlantHarvestYieldOffSet).Value;
            }
        ...
        public static float GetProxPlantWorkSpeedOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxPlantWorkSpeedOffSet).Value;
            }
        ...
        public static float GetProxSmoothingSpeedOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxSmoothingSpeedOffSet).Value;
            }
        ...
        public static float GetProxResearchSpeedOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxResearchSpeedOffSet).Value;
            }
        ...
        public static float GetProxTameAnimalChanceOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxTameAnimalChanceOffSet).Value;
            }
        ...
        public static float GetProxWorkSpeedGlobalOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxWorkSpeedGlobalOffSet).Value;
            }
        ...
        public static float GetProxButcheryFleshSpeedOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxButcheryFleshSpeedOffSet).Value;
            }
        ...
        public static float GetProxButcheryMechanoidSpeedOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxButcheryMechanoidSpeedOffSet).Value;
            }
        ...
        public static float GetProxCookSpeedOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxCookSpeedOffSet).Value;
            }
        ...
        public static float GetProxDrugCookingSpeedOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxDrugCookingSpeedOffSet).Value;
            }
        ...
        public static float GetProxDrugSynthesisSpeedOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxDrugSynthesisSpeedOffSet).Value;
            }
        ...
        public static float GetProxSmeltingSpeedOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxSmeltingSpeedOffSet).Value;
            }
        ...
        public static float GetProxGeneralLaborSpeedOffSet(ThingDef thingdef)
        {
            if (thingdef.HasModExtension<ProximityDefs>())
            {
                return new float?(thingdef.GetModExtension<ProximityDefs>().ProxGeneralLaborSpeedOffSet).Value;
            }
        ...
        public static float GetTProxGlobalLearningFactorOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxGlobalLearningFactorOffSet).Value;
            }
        ...
        public static float GetTProxImmunityGainSpeedOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxImmunityGainSpeedOffSet).Value;
            }
        ...
        public static float GetTProxNegotiationAbilityOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxNegotiationAbilityOffSet).Value;
            }
        ...
        public static float GetTProxSocialImpactOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxSocialImpactOffSet).Value;
            }
        ...
        public static float GetTProxToxicSensitivityOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxToxicSensitivityOffSet).Value;
            }
        ...
        public static float GetTProxComfyTemperatureMinOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxComfyTemperatureMinOffSet).Value;
            }
        ...
        public static float GetTProxMeleeDodgeChanceOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxMeleeDodgeChanceOffSet).Value;
            }
        ...
        public static float GetTProxMeleeHitChanceOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxMeleeHitChanceOffSet).Value;
            }
        ...
        public static float GetTProxMedicalTendSpeedOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxMedicalTendSpeedOffSet).Value;
            }
        ...
        public static float GetTProxMedicalOperationSpeedOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxMedicalOperationSpeedOffSet).Value;
            }
        ...
        public static float GetTProxMedicalSurgerySuccessChanceOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxMedicalSurgerySuccessChanceOffSet).Value;
            }
        ...
        public static float GetTProxAnimalGatherSpeedOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxAnimalGatherSpeedOffSet).Value;
            }
        ...
        public static float GetTProxAnimalGatherYieldOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxAnimalGatherYieldOffSet).Value;
            }
        ...
        public static float GetTProxConstructionSpeedOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxConstructionSpeedOffSet).Value;
            }
        ...
        public static float GetTProxEatingSpeedOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxEatingSpeedOffSet).Value;
            }
        ...
        public static float GetTProxHuntingStealthOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxHuntingStealthOffSet).Value;
            }
        ...
        public static float GetTProxMiningSpeedOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxMiningSpeedOffSet).Value;
            }
        ...
        public static float GetTProxPlantWorkSpeedOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxPlantWorkSpeedOffSet).Value;
            }
        ...
        public static float GetTProxResearchSpeedOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxResearchSpeedOffSet).Value;
            }
        ...
        public static float GetTProxTameAnimalChanceOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxTameAnimalChanceOffSet).Value;
            }
        ...
        public static float GetTProxTrainAnimalChanceOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxTrainAnimalChanceOffSet).Value;
            }
        ...
        public static float GetTProxWorkSpeedGlobalOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxWorkSpeedGlobalOffSet).Value;
            }
        ...
        public static float GetTProxButcheryFleshSpeedOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxButcheryFleshSpeedOffSet).Value;
            }
        ...
        public static float GetTProxButcheryMechanoidSpeedOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxButcheryMechanoidSpeedOffSet).Value;
            }
        ...
        public static float GetTProxButcheryFleshEfficiencyOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxButcheryFleshEfficiencyOffSet).Value;
            }
        ...
        public static float GetTProxCookSpeedOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxCookSpeedOffSet).Value;
            }
        ...
        public static float GetTProxDrugCookingSpeedOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxDrugCookingSpeedOffSet).Value;
            }
        ...
        public static float GetTProxDrugSynthesisSpeedOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxDrugSynthesisSpeedOffSet).Value;
            }
        ...
        public static float GetTProxSmeltingSpeedOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxSmeltingSpeedOffSet).Value;
            }
        ...
        public static float GetTProxGeneralLaborSpeedOffSet(TerrainDef terrain)
        {
            if (terrain.HasModExtension<ProximityDefs>())
            {
                return new float?(terrain.GetModExtension<ProximityDefs>().ProxGeneralLaborSpeedOffSet).Value;
            }
